  ...
  return (
    <div className="w-full relative">
      ...
      <div className="absolute top-2 left-1/2 -translate-x-2/3 md:top-4 md:left-4 md:translate-x-0 bg-white p-3 md:p-8 w-[78vw] max-w-[568px] md:w-[568px] z-10 m-5">
        <div 
          className="text-gray-500 text-base md:text-lg uppercase mb-3 md:mb-4 tracking-wide"
          style={{
        ...
        <div 
          className="text-black text-normal md:text-xl uppercase leading-tight mb-2"
          style={{
            fontFamily: 'Almarai, sans-serif',
            fontWeight: 700
          }}
